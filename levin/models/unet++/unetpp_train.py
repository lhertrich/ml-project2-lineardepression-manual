...
external_image_dir = os.path.abspath("data/training/complete_data_augmented/images")
external_mask_dir = os.path.abspath("data/training/complete_data_augmented/masks")
