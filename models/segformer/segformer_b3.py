...
class SegFormer:
    def __init__(self, model_name="nvidia/segformer-b3-finetuned-ade-512-512", num_labels=1):
        """Initializes a SegFormer model object
        
        Args:
            model_name = 'nvidia/segformer-b3-finetuned-ade-512-512': string, the name of pretrained model to use
    ...
    def train(self, dataloader, validationloader, criterion, save_path, epochs=10, learning_rate=1e-4, save=True):
        """ Trains the SegFormer model on a given dataset
