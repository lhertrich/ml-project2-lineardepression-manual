...
# Load files for original augmented and chicago images
...
chicago_validation_dataset = UnetPlusPlusRoadSegmentationDataset(chicago_image_dir, chicago_mask_dir, chicago_validation_images, chicago_validation_masks, encoder_name=encoder_name, pretrained_name=pretrained)
...
save_path = os.path.join(root_path, "unet_plus_plus")
